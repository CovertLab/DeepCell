...
class ReturnValue(object):
	def __init__(self,channels,y, batch,pixels_x,pixels_y,win_x,win_y):
...
# window_size_x and window_size_y define window size
# direc_name is a string containing file path of directory with training data
# saved_direc is a string containing file path of directory for the saved data
# saved_file_name is string defining the name of the saved data file
# training_direcs is an array of strings containing the names of directories containing training images
# channel_names is an array of strings containing the names of channels

def make_training_data(window_size_x, window_size_y, direc_name, saved_direc, saved_file_name, training_direcs,channel_names,return_data=False):

	# Define maximum number of training examples
	max_training_examples = 10000000

	# Load data
	file_name_save = os.path.join(saved_direc, saved_file_name)
	...
	if not return_data:
		...
		return ReturnValue(channels, feature_label, feature_batch, feature_rows, feature_cols, window_size_x, window_size_y)
