...
h51 = np.load('/home/nquach/DeepCell2/trained_networks/2016-07-12_HeLa_all_61x61_bn_feature_net_61x61_1.npz')['loss_history'][()]
h52 = np.load('/home/nquach/DeepCell2/trained_networks/2016-07-12_HeLa_all_61x61_bn_feature_net_61x61_2.npz')['loss_history'][()]
h53 = np.load('/home/nquach/DeepCell2/trained_networks/2016-07-12_HeLa_all_61x61_bn_feature_net_61x61_3.npz')['loss_history'][()]
...
plt.xlabel('Epoch')
plt.ylabel('Average Model Error')
plt.title('Average Model Error: Dropout & No stdnorm')
plt.axis(ax_lim)
...
plt.xlabel('Epoch')
plt.ylabel('Average Model Error')
plt.title('Average Model Error: Batch Normalization & No stdnorm')
plt.axis(ax_lim)
...
plt.xlabel('Epoch')
plt.ylabel('Average Model Error')
plt.title('Average Model Error: Multires net & No stdnorm')
plt.axis(ax_lim)
...
plt.xlabel('Epoch')
plt.ylabel('Average Model Error')
plt.title('Average Model Error: Shearing & No stdnorm')
plt.axis(ax_lim)
...
plt.xlabel('Epoch')
plt.ylabel('Average Model Error')
plt.title('Average Model Error: Batch Normalized Multires net & No stdnorm')
plt.axis(ax_lim)
