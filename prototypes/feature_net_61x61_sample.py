...
file_name_save = os.path.join(trained_network_directory, todays_date + "_HeLa_set1_bn_61x61.h5")
file_name_save_loss = os.path.join(trained_network_directory, todays_date + "_HeLa_set1_bn_61x61.npz")
