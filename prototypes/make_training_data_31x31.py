...
direc_name = os.path.join(base_directory, 'training_data', 'nuclei')
file_name_save = os.path.join(base_directory, 'training_data_npz', 'nuclei_all_cell1_nodilation_31x31.npz')
training_direcs = ["cell1"]#,"cell2","cell3","cell4","cell5","cell6","cell7","cell8"] # , "set3/", "set4/", "set5/", "set6/"]
