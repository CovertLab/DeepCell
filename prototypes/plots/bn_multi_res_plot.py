...
plt.figure(0)
plt.plot(epoch, e1, 'b-', epoch, v1, 'b--', epoch, e2, 'g-', epoch, v2, 'g--', epoch, e3, 'r-', epoch, v3, 'r--', epoch, e4, 'k-', epoch, v4, 'k--')
plt.xlabel('Epoch')
...
filename = '/home/nquach/DeepCell2/prototypes/plots/bn_multires_all.pdf'
